...
public class CrsWindow extends JFrame {
	...
	public CrsWindow() {
		...
		cmbCarModel.setModel(new DefaultComboBoxModel(new String[] {"Make a Selection", "Proton Saga", "Proton Persona", "Proton X50", "Proton X70"}));
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"Ref No", "Date", "Name", "IC/Passport", "Address", "Contact No", "Car Model", "Price (RM)", "T.Months", "M.Installments"
			}
		));
