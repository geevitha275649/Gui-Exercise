...
public class ProtonWindow extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ProtonWindow frame = new ProtonWindow();
	...
	public ProtonWindow() {
		...
		JButton btnBooking = new JButton("Go for Customer Registration System");
		btnBooking.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(contentPane, 
			    "Now you will be redirected to CR System. Thank you");
				
				CrsWindow thirdPage = new CrsWindow();
				thirdPage.setVisible(true);
			}
		});
		btnBooking.setBounds(939, 692, 350, 23);
		contentPane.add(btnBooking);
		
		JTextPane textPane = new JTextPane();
		textPane.setFont(new Font("Tahoma", Font.PLAIN, 11));
		textPane.setBackground(Color.WHITE);
		textPane.setBounds(939, 30, 404, 622);
		...
		SagaButton.setBounds(154, 334, 106, 49);
		...
		PersonaButton.setBounds(645, 334, 106, 49);
		...
		X50Button.setBounds(154, 679, 106, 49);
		contentPane.add(X50Button);
		
		JButton X70Button = new JButton("Proton X70");
		X70Button.setBackground(Color.LIGHT_GRAY);
		...
		X70Button.setBounds(645, 679, 106, 49);
		...
		lblNewLabel.setBounds(293, 30, 319, 23);
		contentPane.add(lblNewLabel);
		
		JFormattedTextField formattedTextField = new JFormattedTextField();
		formattedTextField.setBounds(43, 70, 333, 253);
		contentPane.add(formattedTextField);
		
		JFormattedTextField formattedTextField_1 = new JFormattedTextField();
		formattedTextField_1.setBounds(529, 70, 333, 253);
		contentPane.add(formattedTextField_1);
		
		JFormattedTextField formattedTextField_2 = new JFormattedTextField();
		formattedTextField_2.setBounds(43, 415, 333, 253);
		contentPane.add(formattedTextField_2);
		
		JFormattedTextField formattedTextField_3 = new JFormattedTextField();
		formattedTextField_3.setBounds(529, 415, 333, 253);
